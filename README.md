...
Allows to include multi-exit scenario and also containes 4 other targets other than exits that algorithms has to pick up first in order to find an exit.
